...
contract physicalProduct is Ownable,ERC721 {
    ...
    function claimProduct(uint256 _tokenId,string memory _secretPassword,string memory _secretPin,string memory _email,address _toAccount) public returns (bool result){
        ...
        _transfer(admin, _toAccount, _tokenId);
        tokenIdToClaimer[_tokenId].claimerAddress = _toAccount;
